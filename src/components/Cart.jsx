                ...
                <div className='space-y-12'>
                    {
                        products.map((item, index)=>(
                            <div key={index} className='flex gap-4'>
                                <img src={item.image} alt="" className='w-[100px] border shadow-lg shadow-white' />
                                <div> 
                                ...
                                <div className='flex flex-col gap-4' >
                                    ...
                                    <button className=' w-fit bg-rose-500 px-4 py-2 rounded text-white'onClick={()=>removeCart(item.cartId)}>
